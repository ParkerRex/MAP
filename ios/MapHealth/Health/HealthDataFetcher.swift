...
class HealthDataFetcher: DefaultInitializable, Module, EnvironmentAccessible {
    ...
    func fetchLastTwoWeeksBasalEnergy() async throws -> [Double] {
    ...
    func fetchLastTwoWeeksHRV() async throws -> [Double] {
        try await fetchLastTwoWeeksQuantityData(
    ...
    func fetchLastTwoWeeksWalkingHeartRate() async throws -> [Double] {
        try await fetchLastTwoWeeksQuantityData(
    ...
    func fetchLastTwoWeeksVO2Max() async throws -> [Double] {
        try await fetchLastTwoWeeksQuantityData(
            for: .vo2Max,
    ...
    func fetchLastTwoWeeksOxygenSaturation() async throws -> [Double] {
        try await fetchLastTwoWeeksQuantityData(
    ...
    func fetchLastTwoWeeksRespiratoryRate() async throws -> [Double] {
        try await fetchLastTwoWeeksQuantityData(
            for: .respiratoryRate,
            unit: .count().unitDivided(by: .minute()),
            options: [.discreteAverage]
    ...
    func fetchLastTwoWeeksBodyFat() async throws -> [Double] {
        try await fetchLastTwoWeeksQuantityData(for: .bodyFatPercentage, unit: .percent(), options: [.discreteAverage])
    }

    func fetchLastTwoWeeksLeanBodyMass() async throws -> [Double] {
    ...
    func fetchLastTwoWeeksSleepStages() async throws -> [[String: Double]] {
