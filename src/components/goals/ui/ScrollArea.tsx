...
const ScrollArea = ({ goals }: ScrollAreaProps) => {
  return (
    <RadixScrollArea.Root className="m-auto h-[300px] w-full overflow-hidden rounded">
      ...
      <RadixScrollArea.Scrollbar
        className="duration-[160ms] flex touch-none select-none bg-slate-200 p-0.5 transition-colors ease-out data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
      ...
      <RadixScrollArea.Scrollbar
        className="duration-[160ms] flex touch-none select-none bg-slate-300 p-0.5 transition-colors ease-out data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
