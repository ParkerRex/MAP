...
export default function SignupPage() {
  const handleGoogleSignIn = () => {
    // Redirect to Google OAuth - immediate redirect, no loading state
        ...
        <div className="relative z-20 m-auto flex w-full max-w-[380px] flex-col py-8">
          <div className="flex w-full flex-col relative">
            <div className="pb-4 bg-linear-to-r from-primary dark:via-primary dark:to-[#848484] to-[#000] inline-block text-transparent bg-clip-text">
              <h1 className="font-medium pb-1 text-3xl">Get started with MAP.</h1>
            </div>
            ...
            <p className="text-xs text-[#878787] mt-6 text-center">
