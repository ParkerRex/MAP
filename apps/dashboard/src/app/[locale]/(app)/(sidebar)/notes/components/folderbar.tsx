...
import { addFolder, deleteFolder, renameFolder } from "../actions";

import type { FolderBarProps, FolderType, LinkItem, Note } from "@/types";
import useLastSelectedFolder from "../useLastSelectedFolder";
...
export default function FolderBar({
  ...
  const [selectedFolderId, setSelectedFolderId] = useLastSelectedFolder(null);
