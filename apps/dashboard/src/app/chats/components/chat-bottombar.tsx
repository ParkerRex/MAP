...
import { type Message, loggedInUserData } from "./data";
...
export default function ChatBottombar({ sendMessage }: ChatBottombarProps) {
  ...
  return (
    <div className="p-2 flex justify-between w-full items-center gap-2 bg-background dark:bg-dark-background">
      <div className="flex">
        <Popover>
          <PopoverTrigger asChild>
            <Link
              ...
              className={cn(
                ...
                "h-9 w-9 text-foreground dark:text-dark-foreground",
                "hover:bg-muted hover:text-white",
              )}
            >
              <PlusCircle
                size={20}
                className="text-muted-foreground dark:text-dark-foreground"
              />
            </Link>
          </PopoverTrigger>
