...
export const metadata: Metadata = {
  title: "Download",
  description:
    "With map on Mac you have everything accessible just one click away.",
};
...
export default function Page() {
  return (
    <div className="container flex flex-col items-center mb-12 md:mb-48 text-center">
      ...
      />
      <p className="mb-4 text-2xl	font-medium mt-8">MAP for Mac</p>
      <p className="text-[#878787] font-sm max-w-[500px]">
        With map on Mac you have everything <br />
        accessible just one click away.
      </p>

      <a href="https://go.map.ai/d" download>
        <Button
          variant="outline"
      ...
      <CopyInput
        value="curl -sL https://go.map.ai/d | tar -xz"
