    ...
    <footer className="w-full bg-white py-16">
      <div className="container mx-auto px-4 xl:max-w-none xl:px-16">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="w-full md:w-1/3 mb-12 md:mb-0">
            ...
            <div className="flex space-x-4 mb-6">
              <Link href="https://x.com/map_hq" aria-label="Twitter">
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <Link href="https://instagram.com/maphq" aria-label="Instagram">
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <div className="w-full md:w-1/3 flex flex-col items-end">
            <div className="space-y-4 w-full pr-0 md:pr-4">
              <Link href="/about-us" className="block group relative">
                <div className="flex items-center">
                  <span className="text-[24px] md:text-2xl mr-4 md:mr-8">
                    01
                  </span>
                  <span className="text-[34px] md:text-[52px] relative">
                    ABOUT US
              ...
              <Link href="/master-plan" className="block group relative">
                <div className="flex items-center">
                  <span className="text-[24px] md:text-2xl mr-4 md:mr-8">
                    02
                  </span>
              ...
              <Separator className="w-full" />
              <Link href="/culture" className="block group relative">
                <div className="flex items-center">
                  <span className="text-[24px] md:text-2xl mr-4 md:mr-8">
                    03
                  </span>
        ...
        <div className="mt-16 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm mb-4 md:mb-0">&copy; MAP 2024</p>
